...
- Current best subjective 2017 iMac profile from manual testing: BetterDisplay `Virtual 16:9` at `2560x1440`, HiDPI on, iBridge stream `3840x2160@60`, `BITRATE_MBPS=200`. This looks sharper than `2560x1440@60 100Mbps`, though still below native iMac quality because the path includes virtual display rendering, ScreenCaptureKit capture, HEVC 4:2:0 compression, and receiver scaling.
